...
<head>
  ...
  <body class="login-body">
    <div class="container">
        <div class="loginLogo" style="position:relative; margin:100px auto 0; left:30%; margin-bottom:2%;">
			<img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/ufba_logo.png" alt="" style=""/>
        </div>
