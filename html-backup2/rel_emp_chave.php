...
<table align = "center" border="2"   cellpadding="0"  cellspacing="1" width=70%>
  ...
  <th align="left"><font size=4 >Usuario: xxxxxxxxx xxxxxxxxxx </th>
...
<table align = "center" border="2"    width=70% HEIGHT="85%">
    ...
    <tr>
        ...
        <td   valign="top" width="80%" >
            ...
            <table border="1" align="center"  cellpadding="0"  cellspacing="1" width="80%" >
                <th colspan=6" align="center"><font size=3 >Historido de Emprestimos</th>
                <tr><td >Chave n�</td>
                    <td >Usuario</td>
                    <td >Matricula</td>
                    <td >Data</td>
