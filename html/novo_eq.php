...
<table align = "center" border="2"   cellpadding="0"  cellspacing="1" width=70%>
    ...
    <th align="left"><font size=4 >Usuario: xxxxxxxxx xxxxxxxxxx ---------- Novo equipamento</th>
    ...
    <tr>
        ...
        <td   width="80%" >
            ...
            <table  align="LEFT"  cellpadding="0"  cellspacing="1"  >
             <tr>	<td>Novo equipamento:<input type="text" name="Neq">  </td> 
                 <td>   </td>
                 <td>Codigo:<input type="text" name="codeq">  </td> 
                 <td>   </td>

                 <td>Quantidade:<input type="text" name="qtdeq">  </td> 
             ...
             <tr>
                <TD><input type="button"  value="Cadastrar"></TD></tr>		  
